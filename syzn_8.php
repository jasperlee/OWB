...
<div class="page_main">
  ...
  <div id="main_1">
    ...
    <div class="text_content" >
          <h3>6.2 用户注册：</h3>
      <h4>6.2.1 注册</h4>
      <p>Doword 的注册非常简单。在 Windows 版客户端的登录界面、Web 版的登录界面以及 www.doword.cn 网站的许多网页中都有注册按钮</p>
      <p>（如图2）。</p>
     <p>&nbsp;</p>
     <div class="zn_pic">
       <P><img src="image/zn_pic5.jpg" width="681" height="360" /></P> 
      </div>
      ...
      <div class="zn_pic">
        <P><img src="image/zn_pic6.jpg" width="456" height="311" /></P> 
      </div>
    ...
    <div class="main_footer">
       <div id="button"><a href="syzn_7">上一页</a> <a href="syzn_9">下一页</a> 第 8 页/共 13  页</div>   
		 <div class = "main_tail">
