...
<body>
    ...
    line-height:30px; color:#000  ">&nbsp;&nbsp;功能性词库介绍</a></div> </li>
						         <li class="li_focus"> <div class="newstitle"><a href="eng_library_4"  style="TEXT-DECORATION:none;  height:30px;
    line-height:30px; color:#FFF  ">&nbsp;&nbsp;普通词库介绍</a></div> </li>					   
					               </div>
						</div>
				...
				<div class="main_4_right">
					<img style="margin-top:5px;" src="image/n_libraray_4.png"></img>
					...
					<div style="margin-left:50px;margin-top:5px;margin-right:50px;font-size:14px;">
						<label style="color:#0000ff;font-weight:bolder;">专业四级核心词汇</label>
						</br>
						<label>专业四级核心词汇&nbsp;&nbsp;共包含2143个单词，按不同的排列方式分为两个子库。</br>
						</label>
					</div>
					<img style="margin-left:10px;margin-top:5px;" src="image/line.png"></img>
					<div style="margin-left:50px;margin-top:5px;margin-right:50px;font-size:14px;">
						<label style="color:#0000ff;font-weight:bolder;">专业八级核心词汇</label>
						</br>
						<label>专业八级核心词汇&nbsp;&nbsp;共包含883个单词，按不同的排列方式分为两个子库。</br>
						</label>
					</div>
					<img style="margin-left:10px;margin-top:5px;" src="image/line.png"></img>
					<div style="margin-left:50px;margin-top:5px;margin-right:50px;font-size:14px;">
