...
<body>
		<div class="main">
			...
			<div style="height:100%;width:800px;border:1px;">
				<div class="main_left">
					<div class="main_left_navigate_bk2">
					
					    <div id="news_list">                                
                                                   <li class="li"> <div class="newstitle"><a href="guide_1"  style="TEXT-DECORATION:none;  height:30px;
    line-height:30px; color:#000 ">&nbsp;&nbsp;关于本指南</a></div> </li>
						   <li class="li"> <div class="newstitle"><a href="guide_2"  style="TEXT-DECORATION:none;  height:30px;
    line-height:30px; color:#000  ">&nbsp;&nbsp;策划者的故事</a></div> </li>
						   <li class="li"> <div class="newstitle"><a href="guide_3"  style="TEXT-DECORATION:none;  height:30px;
    line-height:30px; color:#000  ">&nbsp;&nbsp;强调读单词</a></div> </li>
						   <li class="li"> <div class="newstitle"><a href="guide_4"   style="TEXT-DECORATION:none;  height:30px;
    line-height:30px; color:#000  ">&nbsp;&nbsp;背单词和捋单词</a></div> </li>			
<li class="li"> <div class="newstitle"><a href="guide_5"   style="TEXT-DECORATION:none;  height:30px;
    line-height:30px; color:#000  ">&nbsp;&nbsp;三种试用模式</a></div> </li>
<li class="li_focus"> <div class="newstitle"><a href="guide_6"   style="TEXT-DECORATION:none;  height:30px;
    line-height:30px; color:#000  ">&nbsp;&nbsp;使用说明书</a></div> </li>		
					    </div>
				...
				<div class="main_1_right">
					<img style="margin-top:5px;" src="image/bn_10.png"></img>
