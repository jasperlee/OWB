...
<style type="text/css">
	html,body {padding:0;margin:0;height:1500px;}
	#sub {width:800px;margin:auto;height:1500px;border:1px solid #ccc;border-top:none;background:#C0FE3E;overflow:hidden;}
</style>
...
<div class="page_main">
  ...
  <div id="main_1100">
    ...
    <div class="text_content" >
      <p>a. 对于一个单词进行初试。</p>
       <p>b. 如果初试正确，过192小时后转到i；如果初试错误，过24小时后转到c。<br />
       </p>
       <p>c. 对该单词进行即时复习。<br />
       </p>
       <p>d. 如果即时复习正确，过48小时后转到e; 如果即时复习错误，过24小时后转到c。<br />
       </p>
       <p>e. 对该单词进行第一次复试。</p>
       <p>f. 如果第一次复试正确，过96小时后转到g; 如果第一次复试错误，过24小时后转到c。</p>
       <p>g. 对该单词进行第二次复试。<br />
       </p>
       <p>h. 如果第二次复试正确，过192小时后转到i; 如果第二次复试错误，过24小时后转到c。<br />
      </p>
       <p>i. 对该单词进行终试。</p>
       <p>j. 如果终试正确，该单词背诵过程结束; 如果终试错误，过24小时后转到c。</p>
<p>&nbsp;</p>
      <h4>3.6 相关练习的通用流程 (见流程图)<br />
      </h4>
      <p>《读我背单词》中的所有练习都包含三个环节：练习、纠错和强化。这三个环节让您记忆单词时注意力更集中。具体流程如下： </p>
      <p>&nbsp;</p>

      <div class="zn_pic">
        <P><img src="image/zn_pic3.jpg" width="516" height="474" /></P> 
      </div>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>a. 针对所选单词，一一完成全部练习。</p>
<p>b. 挑选出做错练习的单词。如果有，转c; 如果没有做错的练习，装d。</p>
<p>c. 针对做错练习的全部单词，一一完成全部练习，转到b。</p>
<p>d. 练习结束。转到a进行强化练习。</p>
    </div>
  </div>
  
    <div class="main_footer">
       <div id="button"><a href="syzn_3">上一页</a> <a href="syzn_5">下一页</a> 第 4 页/共 13  页</div>   
		 <div class = "main_tail">
