...
<div class="page_main">
  ...
  <div id="main_1100">
    ...
    <div class="text_content" >
          <h3>3.5 捋单词的单词筛选流程 (见流程图)<br />
          </h3>
<p> 捋单词分为捋发音、捋词义和捋拼写，让您针对记忆单词的三个方面进行强化复习。<br />
特别注意：这三个功能会相互影响，如果您想同时使用这三个功能，请分别选用不同的课程。<br />
我们不能知道捋单词是否对您也是一种有效的单词记忆机制，请您通过捋单词的单词筛选流程去自己体会。</p>
      <div class="zn_pic">
        <P><img src="image/zn_pic2.jpg" width="303" height="873" /></P>
      </div>
    ...
    <div class="main_footer">
       <div id="button"><a href="syzn_2">上一页</a> <a href="syzn_4">下一页</a> 第 3 页/共 13  页</div>   
		 <div class = "main_tail">
