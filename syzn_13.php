...
<style type="text/css">
	html,body {padding:0;margin:0;height:1200px;}
	#sub {width:800px;margin:auto;height:1200px;border:1px solid #ccc;border-top:none;background:#C0FE3E;overflow:hidden;}
</style>
...
<div class="text_content" >
    ...
    <h4>第四步： 启动安装程序后，系统可能会弹出一个对话框提示你，将要运行的程序的发布者未知。无论如何，您选择运行该程序。</h4>
    

    <h4>&nbsp;</h4>
    <h4>&nbsp;</h4>
    <h4>第五步： 后面只需点击"下一步"和"安装"按钮，就可以自动地完成安装（如下图）。</h4>

    <div class="zn_pic">
      <p><img src="image/zn_pic16.jpg" alt="" width="404" height="297" /></p>
</div>
      <h4>&nbsp;</h4>
      <h4>&nbsp;</h4>
      <h4>第六步： 启动。点击桌面中的&quot;读我背单词&quot;程序图标（如下图），就可以启动。</h4>
<p>&nbsp;</p>
        <div class="zn_pic_3">
        <p><img src="image/tb_1.png" alt="" width="78" height="63" /></p>
    </div>
  </div>
  </div>
  
    <div class="main_footer">
       <div id="button"><a href="syzn_12">上一页</a>  下一页  第 13 页/共 13 页</div>   
		 <div class = "main_tail">
