...
<p>&nbsp;</p>
<p>尊敬的用户:</p>
      <p> 您收到这封这封电子邮件是因为您 (也可能是某人冒充您的名义) 申请了一个新的密码。假如这不是您本人所申<br />
      请, 请不用理会这封电子邮件, 但是如果您持续收到这类的信件骚扰, 请您尽快联络管理员。</p>
   
      <p>&nbsp;</p>
      <p>要使用新的密码, 请使用以下链接启用密码:</p>
<p>http://www.doword.cn/ET100/resetpassword.php?email=doword6800@163.com&amp;passcode=f7dad3f2b827faf863b814483e5a0f50((如果无法点击该URL链接地址，请将它复制并粘帖到浏览器的地址输入框，然后单击回车即可。该链接使用后将立即失效。)</p>
      <p>&nbsp;</p>
      <h4>6.3.5</h4>
      <p>点击上述邮件中的链接，进入密码重置页面(如图8)。<br />
      </p>

       <div class="zn_pic_1">
         <p><img src="image/zn_pic11.jpg" alt="" width="451" height="281" /></p>
      </div>
      <h4>6.3.6</h4>
<p>在密码重置的编辑框中输入新密码两次，按提交按钮。密码重置成功(如图9)。</p>
           <div class="zn_pic_1">
         <p><img src="image/zn_pic12.jpg" alt="" width="220" height="237" /></p>
      </div>
    ...
    <div class="main_footer">
       <div id="button"><a href="syzn_10">上一页</a>  <a href="syzn_12">下一页</a>  第 11 页/共 13 页</div>   
		 <div class = "main_tail">
