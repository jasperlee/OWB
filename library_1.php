...
<body>
		<div class="main">
			...
			<div style="height:100%;width:800px;border:1px;">
				<div class="main_left">
					...
					<div id="news_list">                                
                                                         <li class="li_focus"> <div class="newstitle"><a href="library_1"  style="TEXT-DECORATION:none;  height:30px;
    ...
    line-height:30px; color:#000  ">&nbsp;&nbsp;普通词库介绍</a></div> </li>					   
				...
				<div class="main_1_right">
					<img style="margin-top:5px;" src="image/n_词库概述.png"></img>
